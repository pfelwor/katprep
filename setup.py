...
setup(
    ...
    version='0.5.0',
    description='Python toolkit for automating system maintenance and '
'generating patch reports along with Foreman/Katello and Red Hat Satellite 6.x',
    ...
    keywords='foreman katello linux redhat centos satellite6 satellite fedora '
             'maintenance maintenance-tasks maintenance-reports iso27001',
